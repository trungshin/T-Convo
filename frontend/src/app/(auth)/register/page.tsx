          ...
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className="mt-2 space-y-4">
              ...
              <div className="text-center">
                Have an account? <span onClick={goToLogin} className="text-blue-500 hover:underline cursor-pointer">Log in</span>
              </div>
            </form>
          </CardContent>

          <CardFooter className="p-4 justify-center">
            <div className="text-xs text-muted">By continuing, you agree to our Terms & Privacy Policy.</div>
          </CardFooter>
        </Card>
      </div>
    </div>
